...
DATABASES = {
    'default': {
        ...
        'NAME': 'deliverydb',     # matches POSTGRES_DB
...
# Pointer vers ton nouveau modèle utilisateur
AUTH_USER_MODEL = 'logistique.Utilisateur'

# Redirections automatiques
LOGIN_URL = 'login'
LOGIN_REDIRECT_URL = 'home' # Ou ta section "Favoris" [cite: 33]
